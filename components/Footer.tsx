          ...
          {[
            ...
            },
            {
              ...
              items: [
                ...
                { label: "Industrial Canopies", href: "/products" },
                { label: "ATS & Sync Panels", href: "/products" },
                { label: "Control Systems", href: "/products" },
                { label: "Spare Parts", href: "/products" },
                { label: "Maintenance Guidance", href: "/products" },
              ],
            },
            {
              title: "Customer Support",
              items: [
                { label: "Product Catalogues", href: "/products" },
            ...
            <div key={col.title}>
              <h4 className="text-xs font-bold uppercase tracking-widest text-white mb-5 pb-2 border-b-2 border-primary inline-block">
                {col.title}
              </h4>
              <ul className="space-y-2.5">
                {col.items.map((item) => (
                  <li key={item.label}>
                    <Link
                      href={item.href}
                      className="text-slate-400 text-sm hover:text-white transition-colors flex items-center gap-1.5 hover:translate-x-1 duration-200"
                    >
